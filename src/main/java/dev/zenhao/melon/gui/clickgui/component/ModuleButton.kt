...
import dev.zenhao.melon.gui.clickgui.Panel.Companion.toIsVisibleList
...
class ModuleButton(val module: AbstractModule, width: Double, height: Double, father: Panel) : Component() {
    private var fade = 0
